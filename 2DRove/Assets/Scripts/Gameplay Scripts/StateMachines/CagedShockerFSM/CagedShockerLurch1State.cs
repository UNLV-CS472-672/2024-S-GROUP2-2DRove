...
public class CagedShockerLurch1State : CagedShockerBaseState
{
    private Transform player;
    private Rigidbody2D rb;
    private Animator animator;
    private bool flipped = false;
    private float lurchCD = .583f + .05f;
    ...
    {
        //Debug.Log("Entering Lurch1 State...");
    ...
    public override void UpdateState(CagedShockerStateManager CagedShocker)
    {
        if (!lurched)
        {
            ...
            rb.AddForce(Direction * 250f * CagedShocker.lurch1Dist);
        ...
        {
            CagedShocker.SwitchState(CagedShocker.Lurch2State);
        }
        else if(lurchCD < 0 && wantsToAttack)
        {
